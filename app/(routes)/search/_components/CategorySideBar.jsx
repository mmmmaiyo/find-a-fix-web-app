...
params.split('/')[2];
  ...
  return (
    <div>
        <h2 className='font-bold mb-3 text-lg text-primary-PRIMARY'>Categories</h2>
        <div>
            {categoryList.map((category,index)=>(
                ...
                ${selectedCategory==category.name&&'border-primary-PRIMARY text-primary-PRIMARY shadow-md bg-orange-50'}
                `}>
