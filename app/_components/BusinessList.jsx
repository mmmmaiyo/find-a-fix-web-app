            ...
            {businessList.length>0?businessList.map((business,index)=>(
                ...
                hover:scale-105 transition-all ease-in-out'>
                    ...
                    items-baseline p-3 gap-1'>
                        ...
                        text-primary-PRIMARY rounded-full px-2
                        text-[12px]'>{business.category.name}</h2>
                        <h2 className='font-bold text-lg'>{business.name}</h2>
                        <h2 className='text-primary-PRIMARY'>{business.contactPerson}</h2>
                        <h2 className='text-gray-500 text-sm'>{business.address}</h2>
                        <Button className="bg-primary-PRIMARY rounded-lg mt-3">Book Now</Button>
                    </div>
                </Link>
            ))
        :
